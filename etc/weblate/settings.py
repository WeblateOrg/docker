...
# Azure AD Tenant
if 'SOCIAL_AUTH_AZUREAD_TENANT_OAUTH2_KEY' in os.environ:
    AUTHENTICATION_BACKENDS += ('social_core.backends.azuread_tenant.AzureADTenantOAuth2',)

SOCIAL_AUTH_AZUREAD_TENANT_OAUTH2_KEY = os.environ.get('WEBLATE_SOCIAL_AUTH_AZUREAD_TENANT_OAUTH2_KEY', '')
