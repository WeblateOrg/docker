...
docker-compose exec -e WEBLATE_LOGLEVEL=CRITICAL weblate weblate test --noinput weblate.accounts weblate.trans weblate.lang weblate.api weblate.gitexport weblate.screenshots weblate.utils || exit 1
